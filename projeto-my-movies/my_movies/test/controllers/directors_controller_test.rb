...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { birthday: @director.birthday, country: @director.country, gender: @director.gender, name: @director.name, type: @director.type } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { birthday: @director.birthday, country: @director.country, gender: @director.gender, name: @director.name, type: @director.type } }
