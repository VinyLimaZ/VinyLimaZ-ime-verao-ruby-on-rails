...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birthday: @actor.birthday, country: @actor.country, gender: @actor.gender, name: @actor.name, type: @actor.type } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birthday: @actor.birthday, country: @actor.country, gender: @actor.gender, name: @actor.name, type: @actor.type } }
